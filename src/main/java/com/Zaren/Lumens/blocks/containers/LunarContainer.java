...
public class LunarContainer extends Container {

    public final TileEntityLunarBlock tile;
    private final PlayerEntity player;

    public LunarContainer(ContainerType<?> type, int windowId, World world, BlockPos pos, PlayerEntity player)
    {
        super(type, windowId);
        this.tile = (TileEntityLunarBlock) world.getTileEntity(pos);
        this.player = player;
    }
