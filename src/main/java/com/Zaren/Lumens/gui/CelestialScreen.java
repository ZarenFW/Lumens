...
public class CelestialScreen extends ContainerScreen<CelestialContainer>{
    private static final ResourceLocation TEXTURE = new ResourceLocation(Lumens.MOD_ID, "textures/gui/celestial_panel.png");
    ...
    public CelestialScreen(CelestialContainer screenContainer,PlayerInventory inv, ITextComponent titleIn)
    {
    ...
    protected void drawGuiContainerBackgroundLayer(MatrixStack mstack, float partialTicks, int mouseX, int mouseY)
    {
        ...
        if(on>0){
            this.blit(mstack, this.guiLeft + 156, this.guiTop + 70, 192, 0, 17, 17);
        }
            }
    @Override
