...
import com.Zaren.Lumens.blocks.containers.SolarContainer;
import com.Zaren.Lumens.blocks.containers.SolarContainer;
...
public class SolarScreen extends ContainerScreen<SolarContainer>{
    private static final ResourceLocation TEXTURE = new ResourceLocation(Lumens.MOD_ID, "textures/gui/solar_panel.png");
    ...
    public SolarScreen(SolarContainer screenContainer,PlayerInventory inv, ITextComponent titleIn)
    {
    ...
    protected void drawGuiContainerBackgroundLayer(MatrixStack mstack, float partialTicks, int mouseX, int mouseY)
    {
        ...
        if(on>0){
            this.blit(mstack, this.guiLeft + 157, this.guiTop + 71, 192, 0, 17, 17);
        }
    }
    @Override
